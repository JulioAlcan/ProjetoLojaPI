...
public class CadastroLoginView extends javax.swing.JFrame {
     ...
     *
     * Criar uma tabela usuário, e verificar se o que estiver no banco bater com
     * as informações fornecidas em login, acesso liberado
     *
     */
    ...
    private void initComponents() {
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addComponent(txtSenhaC, javax.swing.GroupLayout.PREFERRED_SIZE, 136, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(txtSenhaC, javax.swing.GroupLayout.PREFERRED_SIZE, 25, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void btnInserirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnInserirActionPerformed
        ...
        if (ValidarFormulario()) {
                ...
                if (UsuarioController.salvar(txtNomeCl.getText(), txtCpfCl.getText(), txtCargoCl.getText(), txtUserCl.getText(), txtSenhaC.getText())) {
    ...
    private boolean ValidarFormulario() {
        ...
        if (this.txtNomeCl.getText().equalsIgnoreCase("")) {
            JOptionPane.showMessageDialog(this, "Defina um nome para o cliente!");
            return false;
        }

        if (this.txtCpfCl.getText().equalsIgnoreCase("")) {
            JOptionPane.showMessageDialog(this, "Defina um CPF para cliente!");
            return false;
        }
        if (this.txtCargoCl.getText().equalsIgnoreCase("")) {
            JOptionPane.showMessageDialog(this, "Defina um cargo para cliente!");
            return false;
        }
        if (this.txtUserCl.getText().equalsIgnoreCase("")) {
            JOptionPane.showMessageDialog(this, "Defina um usuário para cliente!");
            return false;
        }
        if (this.txtCargoCl.getText().equalsIgnoreCase("")) {
            JOptionPane.showMessageDialog(this, "Defina um cargo para cliente!");
        ...
        if (this.txtSenhaC.getText().equalsIgnoreCase("")) {
            JOptionPane.showMessageDialog(this, "Defina uma senha para cliente!");
            return false;
        }
        if (this.txtSenhaAdmin.getText().equalsIgnoreCase("")) {
            JOptionPane.showMessageDialog(this, "Insira a senha de admin!");
            return false;
        }
        return true;
    }
